---
title: Discord Setup
description: Connect Agentspace to Discord.
---

# Discord Setup

Connect Agentspace to your Discord server. Takes about 5 minutes.
...
## Step 5: Add Token to Agentspace
...
- In quiet mode, Agentspace only replies to slash commands, `@mentions`, or
