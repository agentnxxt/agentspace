---
title: Slack Setup
description: Connect Agentspace to Slack.
---

# Slack Setup

Connect Agentspace to your Slack workspace. Takes about 5 minutes.
...
You'll be prompted to create an **App-Level Token**. Give it a name (e.g. "agentspace") and add the `connections:write` scope. Click **Generate**.
...
These tell Slack which message events to send to Agentspace. Without them, the bot won't see messages in the corresponding channel types.
...
## Step 7: Add Tokens to Agentspace
